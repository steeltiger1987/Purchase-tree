		...
		<h3 class="page-title">Add User Management</h3>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.currency.edit',$currency->id)}}">Edit Currency</a>
					</li>
				</ul>
			</div>
			<div class="row">
                                            ...
                                            <div class="form-group" id="countryname">
                                                 <label class="col-md-3 col-sm-3 col-xs-12 control-label">{{ Form::label($key, $value) }}</label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                      {{ Form::text($key, $currency->$key, ['class' => 'form-control','placeholder'=>$value]) }}
                                                 </div>
                                            </div>
                                      @endforeach
							    </div>
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-7 col-md-5">
											...
											<a class="btn  green" href="{{URL::route('admin.currency')}}"><i class="fa fa-repeat" style="margin-right:4px"></i>Cancel</a>
										</div>
									</div>
								</div>
							</form>
