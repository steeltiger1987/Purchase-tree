    ...
    @section('body')
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <i class="fa fa-pencil"></i>
                    <a href="{{URL::route('admin.escrow.email.edit', $email->id)}}">Edit Email Template</a>
                </li>
            </ul>
        </div>
        <div class="row">
                                      ...
                                      @if($key === 'title')
                                           <div class="form-group" id="countryname">
                                               ...
                                               <div class="col-md-7 col-sm-7 col-xs-12">
                                                  <textarea class="form-control" name="title" id="title">{{$email->title}}</textarea>
                                               </div>
                                           </div>
                                      @else
                                            <div class="form-group" id="countryname">
                                               <label class="col-md-3 col-sm-3 col-xs-12 control-label">{{ Form::label($key, $value) }} <span style="color:red">*</span></label>
                                               <div class="col-md-7 col-sm-7 col-xs-12">
                                                  <textarea class="form-control" name="content" id="content" rows="10">{{$email->content}}</textarea>
