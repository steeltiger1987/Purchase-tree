@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Add Escrow Page Management</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.escrow.pages.create')}}">Add Escrow Page</a>
					</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							@endif
							<form  class="form-horizontal" id="addCategoryFiledForm" method="POST" action="{{URL::route('admin.escrow.pages.store')}}" enctype="multipart/form-data">
