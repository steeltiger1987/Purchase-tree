                              ...
                              <tr>
                                  ...
                                  <td @if($value->admin_active == 0) class="classBeActive" @endif>
                                       <a class="btn btn-xs blue" data-toggle="modal" href="javascript:void(0)" onclick="onShowModal(<?php echo $value->id; ?>)">
                                         ...
                                         <form action="{{ URL::route('admin.members.confirmSeller' , $value->id) }}" id="formTest" onsubmit = "return onDelteConfirm(this)" style="display:inline-block">
    ...
    @section('custom-scripts')
		...
		<script type="text/javascript">
			...
			function onModalSend(){
                ...
                if(messageContent == "") {bootbox.alert("Please insert message content"); return;}
                 $.ajax ({
