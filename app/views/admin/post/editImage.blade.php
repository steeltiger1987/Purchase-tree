...
@endsection
@section('body')
    <h3 class="page-title">Edit Product Image Management</h3>
    <!-- page layout -->
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{URL::route('admin.post.add',$product->id)}}">Edit Product Image</a>
            </li>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div class="margin-bottom-30">
                                ...
                                <span class="fileinput-new" id="select_image" style="display: none"> Select image </span>
                                <span class="fileinput-exists"  id="change_image" style="display: block">Change </span>
                                <input type="file" name="file_upload" id="uploadMainImage">
                                </span>
                                <a href="javascript:void(0)" class="btn default fileinput-exists display-inline-block" data-dismiss="fileinput" id="remove_image" onclick="onChangeRemove()" style="display: inline-block">Remove </a>
                            </div>
                        </div>
                    </div>
