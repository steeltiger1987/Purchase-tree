        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a id="sample_editable_1_new" class="btn btn-default btn-sm" href='{{ URL::route('admin.post.create')}}' style="margin-right:10px">
                        ...
                        <tbody>
                            @foreach ($product as $key => $value)
                              <tr>
                                  ...
                                  <td @if($value->admin_active == 0) class="classBeActive" @endif>{{ $value->product_name }}</td>
                                  <td @if($value->admin_active == 0) class="classBeActive" @endif>{{ $value->meta }}</td>
                                  <td @if($value->admin_active == 0) class="classBeActive" @endif>{{ substr($value->created_at,0,10) }}</td>
