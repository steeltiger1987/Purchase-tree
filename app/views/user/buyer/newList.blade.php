                        ...
                        <div class="row">
                            <div class="panel panel-default margin-bottom-40 change-panel">
                                <div class="panel-body">
                                   ...
                                   <div class="col-md-12">
                                        <form action="{{URL::route('user.buyer.storeEmail')}}" method="post" class="form-horizontal reg-page">
                                            <?php if (isset($alert)) { ?>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-4 col-xs-offset- col-lg-8 col-md-6 col-sm-6 col-xs-7">
                                                    ...
                                                    <a href="{{URL::route('user.buyer.email',$slug)}}" class="btn-u btn-u-red">{{Lang::get('user.cancel')}}</a>
                                                </div>
                                            </div>
                                        </form>
                                   </div>
