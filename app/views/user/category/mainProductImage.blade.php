@if(count($productPicture1)>0)
    <a id="Zoom-1" class="MagicZoom" href="{{HTTP_LOGO_PATH.$productPicture1[0]->picture_url}}">
        <img src="{{HTTP_LOGO_PATH.$productPicture1[0]->picture_url}}?scale.height=400"  id="imageList">
    </a>
    <div class="selectors">
