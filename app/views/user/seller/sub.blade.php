    ...
    @section('body')
        <div class="breadcrumbs">
            <div class="container">
                <h1 class="pull-left">
                    <?php
                        echo ucfirst($subCategory->subcategoryname);
                    ?>
                </h1>
                 <ul class="pull-right breadcrumb">
                        ...
                        <li class="active"><a href="{{URL::route('user.seller.sub',array($user_id,$subCategoryID))}}">{{ucfirst($subCategory->subcategoryname)}}</a></li>
                    </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <ul class="list-group sidebar-nav-v1" id="sidebar-nav">
                        @foreach($subCategorys as $key=>$subCategoryItem)
                             <li class="list-group-item <?php if($subCategoryID == (100000*1+$subCategoryItem->subcategory_id)) {echo 'active';}?>">
